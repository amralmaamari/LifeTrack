...
namespace LifeTrackDL
{
    ...
    public class clsTasksData
    {
        ...
        public static Nullable<int> AddNewTasks(TasksDTO tasks, SqlConnection connection, SqlTransaction transaction)
        {
            Nullable<int> NewTasksID = null;

            using (SqlCommand command = new SqlCommand("SP_AddNewTasks", connection, transaction))
            {
                command.CommandType = CommandType.StoredProcedure;
